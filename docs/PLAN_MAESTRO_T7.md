...
| Precisión de la fuente | T07 archivó planta de 1536 × 813 px e isométrica de 915 × 826 px, con contenido nativo comprobado, más la composición de la lámina en `references/derived/p20-t7/` | Ampliar el PDF mejora la lectura, pero no crea cotas ni precisión de CAD. Las superposiciones de la página también se conservan y se comparan en T08. |
| Clasificación gráfica | T08 registra 89 grupos en nueve familias; 12 quedan con confianza media, documentados en `architecture/classification/README.md` | No extruir rectángulos localizadores, achurados del baño, arcos ni líneas de mobiliario. El despiece exacto, las alturas y las superficies siguen en T11–T15. |
| Inventario dimensional | T09 registra 14 cotas locales, ocho rótulos de 15 cm, 28 códigos sin espesor acreditado y referencias de superficie/componentes, con revisión de las 42 páginas | Las cotas locales proponen cm como unidad inferida, contrastada en T10; no se encontró cadena general acotada ni cuadro de espesores T7. Ver `architecture/measurements/README.md`. |
| Calibración de trabajo | T10 fija 0,008459347583241785 m/px, origen en esquina interior inferior izquierda de D1 y ejes sin giro ni deformación desigual | Tres cotas de ajuste y controles separados, máximo residuo seleccionado de 4,586 mm; sensibilidad del raster registrada. No valida toda la arquitectura ni las superficies. Ver `architecture/calibration/README.md`. |
| Trazado 2D | T11 registra 40 paños, 13 vanos/pasos, seis puertas de recinto con pivotes y giros, cinco hojas de mobiliario visibles y 106 vértices de borde | Caras compartidas, sin solapes de paños ni vanos ocupados por huellas de muro. Celosía de logia probable; P06 conserva discrepancia gráfica de 1 px para T22. Medidas inferidas, borde superior recortado y alturas pendientes. Ver `architecture/plan/README.md`. |
| Baño y logia | T12 confirma un baño continuo con ducha al fondo y logia independiente desde cocina; registra doce elementos y áreas de uso | Sin tabiques sobre achurados o símbolos ni acceso lateral baño-logia. Identidad de dos equipos, instalaciones y alturas siguen provisionales. Ver `architecture/topology/README.md`; no acredita acceso físico ni superficie. |
...
- Origen fijado en T10: esquina interior inferior izquierda del dormitorio 1, sobre el piso terminado. Corresponde a `(u, v) = (22,292490118577074; 630,9126213592233)` px en la planta nativa; transformación completa en `architecture/calibration/t10-calibracion.json`.
