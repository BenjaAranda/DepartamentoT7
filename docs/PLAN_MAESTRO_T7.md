...
| Clasificación gráfica | T08 registra 89 grupos en nueve familias; 12 quedan con confianza media, documentados en `architecture/classification/README.md` | No extruir rectángulos localizadores, achurados del baño, arcos ni líneas de mobiliario. Calibración, geometría exacta y superficie siguen pendientes de T10–T15. |
| Inventario dimensional | T09 registra 14 cotas locales, ocho rótulos de 15 cm, 28 códigos sin espesor acreditado y referencias de superficie/componentes, con revisión de las 42 páginas | Las cotas locales proponen cm como unidad inferida; no se encontró cadena general acotada ni cuadro de espesores T7. T10 debe contrastar controles independientes antes de fijar escala. Ver `architecture/measurements/README.md`. |
