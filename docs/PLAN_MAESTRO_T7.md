...
| Clasificación gráfica | T08 registra 89 grupos en nueve familias; 12 quedan con confianza media, documentados en `architecture/classification/README.md` | No extruir rectángulos localizadores, achurados del baño, arcos ni líneas de mobiliario. Cotas, geometría exacta y superficie siguen pendientes de T09–T15. |
